...
| Board connectivity and component metadata | Custom KiCad S-expression/geometry parser plus generated I2C electrical config | KiCad connectivity/DRC | Component collections, PCB values, pad nets, and controller-side endpoint connectivity drive I2C pulls; peripheral bus reachability is checked independently. Remaining electrical topology and geometry are still partial |
